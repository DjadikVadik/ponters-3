...
//  Завдання 1. Дани два масиви : А[M] і B[N](M і N вво -
...
int main()
{
	...
	int* pArr3 = copy_shared_items(pArr1, size1, pArr2, size2, size3); // создаем 3й масиив и заполняем его элементами, которых нет во втором массиве, но есть в первом
